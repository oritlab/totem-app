      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`cursor-pointer ${columns === 3 ? "text-zinc-900" : "text-zinc-400"}`}
          >
            <svg width="30" height="18" viewBox="0 0 30 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5.28947 0.5H0.5V17.5H5.28947V0.5Z" fill="currentColor" stroke="currentColor"/>
              <path d="M13.0785 0.5H8.28906V17.5H13.0785V0.5Z" fill="currentColor" stroke="currentColor"/>
              <path d="M21.1801 0.5H16.3906V17.5H21.1801V0.5Z" fill="currentColor" stroke="currentColor"/>
            </svg>
          </button>
          ...
          <button
            ...
            className={`cursor-pointer ${columns === 4 ? "text-zinc-900" : "text-zinc-400"}`}
          >
